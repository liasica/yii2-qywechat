...
class WXBizMsgCrypt
{
	...
	*/
     ...
     * @internal param string $replyMsg 公众平台待回复用户的消息，xml格式的字符串
     * @internal param string $timeStamp 时间戳，可以自己生成，也可以用URL参数的timestamp
     * @internal param string $nonce 随机串，可以自己生成，也可以用URL参数的nonce
     * @internal param string $encryptMsg 加密后的可以直接回复用户的密文，包括msg_signature, timestamp, nonce, encrypt的xml格式的字符串,
     *                      当return返回0时有效
     */
     ...
     * @param      $sMsg
     * @return int 成功0，失败返回对应的错误码
     * @internal param string $msgSignature 签名串，对应URL参数的msg_signature
     * @internal param string $timestamp 时间戳 对应URL参数的timestamp
     * @internal param string $nonce 随机串，对应URL参数的nonce
     * @internal param string $postData 密文，对应POST请求的数据
     * @internal param string $msg 解密后的原文，当return返回0时有效
     */
